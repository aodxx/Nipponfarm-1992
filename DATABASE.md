...
โครงสร้างฐานข้อมูลทั้งหมด ออกแบบไว้ล่วงหน้าครบทุกเฟส เพื่อไม่ให้ต้อง migrate โครงสร้างใหญ่ภายหลัง DDL เต็มอยู่ที่ `docs/schema.sql` — ไฟล์นี้อธิบายเหตุผลและความสัมพันธ์ของแต่ละตาราง

**สถานะ:** ออกแบบไว้แล้ว (เอกสาร) — ยังไม่ได้รันจริงบน Supabase project ใดๆ
